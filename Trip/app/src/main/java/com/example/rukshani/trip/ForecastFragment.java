...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mForecastAdapter=new ArrayAdapter<String>(
                getActivity(),
                R.layout.weather_list_item_forecast,
                R.id.weather_list_item_forecast_textview,
                weekForecast);

        ListView listView=(ListView)rootView.findViewById(R.id.weather_listview_forecast);
...
// Will contain the raw JSON response as a string.
        ...
        //    String city=cityName2;
            ...
            try {
                ...
                //http://api.openweathermap.org/data/2.5/forecast/daily?q=60000&mode=json&units=metric&cnt=7
